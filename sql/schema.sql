...
CREATE TABLE IF NOT EXISTS controllers (
  ...
  note TEXT NULL,
  pairing_status ENUM('pending', 'claimed', 'active', 'error') NOT NULL DEFAULT 'pending',
  provision_key_hash VARCHAR(255) NULL,
  provision_key_issued_at DATETIME NULL,
  provision_key_expires_at DATETIME NULL,
